...
$(function() {
    ...
    var latitude = 37.232863,
        longitude = -3.648840,
        map_zoom = 17;

    //google map custom marker icon - .png fallback for IE11
    var is_internetExplorer11 = navigator.userAgent.toLowerCase().indexOf('trident') > -1;
    var marker_url = (is_internetExplorer11) ? 'assets/images/pin2.png' : 'assets/images/pin2.svg';
    ...
    $("#contactForm").validate({
        ...
        messages: {
            name: {
                ...
                lettersonly: "Solamente se aceptan letras!"
            },
            email: {
                required: "Por favor, introduzca su dirección de correo electrónico",
                minlength: "Minimo 6 caracteres",
                email: "Esta es una dirección de email no válida"
            },
            phone: {
                required: "Por favor, introduzca su número de teléfono",
                digits: "Solamente se pueden introducir números (sin espacios)",
